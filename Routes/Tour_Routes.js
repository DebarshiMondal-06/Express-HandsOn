...
const { uploadTourImages, ressizeTourImages, get_monthly_plan, get_tour_stats, get_all_tours, create_tours, get_tour, delete_a_tour, update_tour, best_5_middleware } = require('../Controllers/TourController.js');
...
Tour_Router.route('/:id')
      .get(get_tour)
      .patch(authController.protect, authController.restrict('admin'), uploadTourImages, ressizeTourImages, update_tour)
